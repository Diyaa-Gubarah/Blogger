...
# https://stackoverflow.com/questions/52106944/how-do-i-raise-permissiondenied-redirect-to-another-page-using-cbv
    ...
    def handle_no_permission(self):
        # add custom message
        messages.error(self.request, 'You have no permission to create post in {} group please join first'.format(self.kwargs.get('slug')),extra_tags='alert')
    ...
    def test_func(self):
        try:
            ...
            if current_user_membership:
                print('{} is a member in {} group'.format(self.request.user,current_user_membership.group.name))
